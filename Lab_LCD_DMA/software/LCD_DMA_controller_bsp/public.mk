...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../QsysProject.sopcinfo
...
# Design Name 
# setting SOPC_NAME is QsysProject
SOPC_NAME := QsysProject
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2001090
SOPC_SYSID_FLAG += --sidp=0x2001090
ELF_PATCH_FLAG  += --sidp 0x2001090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1603978628
SOPC_SYSID_FLAG += --timestamp=1603978628
ELF_PATCH_FLAG  += --timestamp 1603978628
